...
if [ $# -ge "4" ]; then
	...
	${scriptPath}/testTools/testScript.sh $lxcNetworkDefault_IP 2865 5201 6379 1234
	cd ..
	...
	${scriptPath}/testTools/testScript.sh $kvmNetworkDefault_IP 2865 5201 6379 1234
	cd ..
	...
	echo "usage: basicLocalTest.sh testName local_IP lxcBridgeBr0_IP kvmBridgeBr0_IP [lxcNetworkDefault_IP] [kvmNetworkDefault_IP]"
